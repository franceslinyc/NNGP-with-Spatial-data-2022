...
Instructions for using the hpc cluster, `r` codes, `sh` files, and `log` files are in the [hpc](https://github.com/franceslinyc/NNGP-with-Spatial-data-2022/tree/main/hpc) folder. 
