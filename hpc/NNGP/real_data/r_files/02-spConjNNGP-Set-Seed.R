...
start.time <- Sys.time()
set.seed(123456)
bcef.c.seed <- spConjNNGP(FCH~PTC,
                     coords = c("x","y"),
                     data = BCEF.mod,
...
saveRDS(bcef.c.seed, file = "bcef.c.seed.rds")

# Add model diagnostics 
bcef.c.seed.diag <- spDiag(bcef.c.seed)
saveRDS(bcef.c.seed.diag, file = "bcef.c.seed.diag.rds")
