...
Interested readers are referred to *Section 2.1* of Finley et al. (2019) for more and **Algorithm 1** and **2** in the same section for algorithmic details, and note that the collapsed NNGP model is not implemented in the `spNNGP` package. 
...
Interested readers are referred to **Algorithm 3** and **4** in *Section 2.2* of Finley et al. (2019) for algorithmic details. 
...
Interested readers are again referred to **Algorithm 5** in *Section 2.3* of Finley et al. (2019) for algorithmic details. 
...
(1) This project reviews NNGP models formation and `spNNGP` **R** package usage in Finley et al., (2021). However, algorithmic details as well as where and how parallelization is used in each algorithm are not well explored but can be referred to Finley et al., (2019). 
