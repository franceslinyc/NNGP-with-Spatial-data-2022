...
Interested readers are referred to *Section 2.1. Collapsed NNGP* of Finley et al. (2019) for more and **Algorithm 1** and **2** in the same section for algorithmic details, and note that the collapsed NNGP model is not implemented in the `spNNGP` package. 
...
Interested readers are referred to **Algorithm 3** and **4** in *Section 2.2. NNGP for the Response* of Finley et al. (2019) for algorithmic details. 
