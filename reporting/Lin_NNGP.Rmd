...
Functions in the **R** package `spNNGP` is written in **C/C++** via **R**'s foreign language interface and uses **openMP** (Dagum & Menon, 1998) for parallelization and **Fortran**'s Basic Linear Algebra Subprograms (BLAS; www.netlib.org/blas), e.g., `openBLAS` (Zhang, 2016), and Linear Algebra Package (LAPACK; www.netlib.org/lapack) for computationally intensive matrix operations (Finley et al., 2019; Finley et al., 2021). 
