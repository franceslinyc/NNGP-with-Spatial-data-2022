...
(3) For the simulated data set, 
, but run time as a function of sample size is approximately linear. 

(4) Since enabling **openMP** on a macOS laptop took weeks but it did not provide much computational advantages even when being enabled, for the real data set, we decide to run the models on a hpc cluster.   
