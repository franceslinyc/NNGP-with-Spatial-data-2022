---
title: "NNGP Models with Spatial Examples of Simulated Data and Forest Canopy Height" 
author: "Frances Lin"
date: "Dec 2022"
output: pdf_document
...
Section 2 reviews Gaussian process (GP), introduces sparsity through graphical model and formulates nearest neighbor Gaussian process (NNGP). Section 3 introduces the latent NNGP model, which is followed by three alternate formulations of the latent NNGP model: (1) a collapsed NNGP model, (2) a NNGP model for the response (with no latent process), and (3) a conjugate NNGP model that allows for MCMC-free exact inference. Section 4 ...... Section 5 includes the discussion. ...... are included in the Appendix. 
