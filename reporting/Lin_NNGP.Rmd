...
Recall that by chain rule, joint density... can be expressed as a product of conditional densities. That is, 
$$
p(w_\mathcal{S}) = 
$$
$$
...
Next replace the right-hand side of... with smaller, carefully chosen, conditional sets of size at most $m$, where $m \ll k$ ()..., then 
$$
